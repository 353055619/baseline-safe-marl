...
# === 你需要填入的信息 ===
JOIN_KEY = "ocj_example_team_01"   # 必填：你的一次性 join key
AGENT_NAME = "phd2" # 必填：你在办公室里的名字
OFFICE_URL = "https://distribute-notifications-limitations-launched.trycloudflare.com"  # 海辛办公室地址（一般不用改）
